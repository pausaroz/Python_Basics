...
####        
##### 2.
####text = input("Enter some of text: ")
####    
####try:
####    number = int(input("Enter number: "))
####    print(f"Charackter on {number} index is: {text[number]}")
####except IndexError:
####    print("Number is bigger than length (len-1) of text.")
####except ValueError:
####    print("I need a number, NOT letter")
####
##### ------8.7------
##import random
...
##
##def roll():
##    """Return random integer between q and 6"""
##    return randint(1, 6)
##    
###2.
##
